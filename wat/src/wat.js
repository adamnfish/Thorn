...
(async () => {
  ...
  await creator.click('text=Create game');
  ...
  await player1.click('text=Join game');
  ...
  // creator start game
  await creator.click("text=Start game");
  ...
  await creator.click("text=Rose");
  await creator.click("text=Submit");
  ...
  await player1.click("text=Rose");
  await player1.click("text=Submit");
  await player2.click("text=Rose");
  await player2.click("text=Submit");
